...
<p align="center">
  ...
  ·
  <a href="https://github.com/HaolemeApp/Haoleme/releases/download/v1.0.3/Haoleme-1.0.3.apk">Download APK</a>
  ·
...
> [!NOTE]
> **Haoleme v1.0.3 is a stable release.** Computers can now push live output and device meters over WebSocket, while the app still falls back to SSE and HTTP. Model-training progress monitoring remains a feature in development.
...
[Download Haoleme v1.0.3](https://github.com/HaolemeApp/Haoleme/releases/download/v1.0.3/Haoleme-1.0.3.apk)
