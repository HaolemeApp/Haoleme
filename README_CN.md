...
<p align="center">
  ...
  ·
  <a href="https://github.com/HaolemeApp/Haoleme/releases/download/v1.0.4/Haoleme-1.0.4.apk">下载 APK</a>
  ·
  <a href="#快速开始">快速开始</a>
  ·
...
> [!NOTE]
> **好了么 v1.0.4 是稳定版本。** 底部导航现已对齐，实时命令摘要更加可靠；实时同步仍会从 WebSocket 自动降级至 SSE 和 HTTP。模型训练进度监控仍属于开发中功能。
...
[下载好了么 v1.0.4](https://github.com/HaolemeApp/Haoleme/releases/download/v1.0.4/Haoleme-1.0.4.apk)
